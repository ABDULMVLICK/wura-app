...
const STATUS_CONFIG: Record<string, { label: string; bgColor: string; textColor: string; dotColor: string }> = {
    ...
    BRIDGE_PROCESSING: { label: "Transfert crypto", bgColor: "#F5F3FF", textColor: "#7C3AED", dotColor: "#8B5CF6" },
    BRIDGE_SUCCESS: { label: "Crypto envoyée", bgColor: "#ECFDF5", textColor: "#059669", dotColor: "#10B981" },
