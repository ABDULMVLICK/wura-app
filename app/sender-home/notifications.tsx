...
export default function SenderNotificationsScreen() {
    ...
    const items = [
        {
            key: "transferts" as const,
            icon: Bell,
            color: "#F59E0B",
            label: "Statut des transferts",
            desc: "Confirmation, traitement et livraison",
        },
        {
            ...
            color: "#3B82F6",
            label: "Rappels",
            desc: "Transferts en attente ou à finaliser",
        },
        {
            key: "promos" as const,
            icon: Tag,
            ...
            desc: "Taux avantageux et frais réduits",
        },
        {
