...
const FAQ = [
    {
        ...
        a: "Depuis l'accueil, appuyez sur « Envoyer », sélectionnez un bénéficiaire ou ajoutez-en un nouveau, choisissez le montant et confirmez le paiement mobile.",
    },
    {
        q: "Quels sont les délais de transfert ?",
        a: "Le mode INSTANT livre les fonds en moins de 30 minutes. Le mode STANDARD prend entre 1 et 3 jours ouvrables.",
    },
    {
        q: "Quels frais sont appliqués ?",
        a: "Les frais varient selon le montant et le mode choisi. Ils sont affichés clairement avant confirmation du transfert.",
    },
    {
        q: "Comment récupérer un transfert échoué ?",
        a: "Rendez-vous dans l'historique, ouvrez la transaction concernée et appuyez sur « Signaler un problème ». Notre équipe vous contactera.",
    },
    {
        q: "Mon bénéficiaire n'a pas reçu l'argent",
        a: "Vérifiez le statut de la transaction dans l'historique. Si le statut est « Terminé », le bénéficiaire doit vérifier son compte. Sinon, contactez le support.",
    },
];

export default function SenderSupportScreen() {
    ...
    const handleSendEmail = () => {
        ...
        const subject = encodeURIComponent(`[Wura Sender] ${sujet}`);
        const body = encodeURIComponent(`Bonjour,\n\n${message}\n\n---\nEnvoyé depuis l'application Wura Sender`);
                ...
                <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 40 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                    ...
                    <View style={{ backgroundColor: '#ffffff', borderRadius: 24, padding: 18, marginBottom: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 4 }}>
                        ...
                        <View style={{ backgroundColor: '#F9FAFB', borderRadius: 14, borderWidth: 1, borderColor: '#E5E7EB', paddingHorizontal: 14, paddingVertical: 12, marginBottom: 14 }}>
                            <TextInput
                                ...
                                placeholder="Ex: Problème avec un transfert"
                    ...
                    <View style={{ backgroundColor: '#ffffff', borderRadius: 24, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 4 }}>
                        ...
                        <View style={{ paddingHorizontal: 18, paddingVertical: 16 }}>
                            ...
                            <Text style={{ fontFamily: 'Outfit_400Regular', fontSize: 12, color: '#9CA3AF', marginTop: 2 }}>1.0.0 • Wura Sender</Text>
                        </View>
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
