...
import { AlertTriangle, ArrowLeft, Eye, Fingerprint, Key, Lock, LogOut, Smartphone } from "lucide-react-native";
import { useState } from "react";
import { Alert, ScrollView, Switch, Text, TouchableOpacity, View } from "react-native";
import { SafeAreaView } from "react-native-safe-area-context";
import { BottomTabBar } from "../../components/BottomTabBar";

export default function ReceiverSecuriteScreen() {
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#14533d' }}>
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingVertical: 16 }}>
                    ...
                    <Text style={{ fontFamily: 'Outfit_700Bold', fontSize: 17, color: '#ffffff' }}>Sécurité & Confidentialité</Text>
                    <View style={{ width: 42 }} />
                </View>
